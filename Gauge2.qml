...
CircularGauge {
    ...
    style: CircularGaugeStyle {
        ...
        background: Rectangle {
            implicitHeight: gauge2.height
            implicitWidth: gauge2.width
            color: "black"
            ...
            Canvas {
                property int value: gauge2.value
                ...
                onPaint: {
                    ...
                    ctx.arc(outerRadius,
                          ...
                          degreesToRadians(valueToAngle(gauge2.value) - 90),
                          degreesToRadians(valueToAngle(gauge2.maximumValue + 1) - 90));
                    ctx.stroke();
                }
            }
        }
        ...
        tickmarkLabel:  Text {
            ...
            color: styleData.value <= gauge2.value ? "lightgray" : "darkgray"
            antialiasing: true
        }
        ...
        minorTickmark: Rectangle {
            ...
            antialiasing: true
            smooth: true
            color: styleData.value <= gauge2.value ? "darkgray" : "lightgray"
        }
    }
}
